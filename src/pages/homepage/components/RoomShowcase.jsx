...
const RoomShowcase = () => {
  ...
  const rooms = [
  {
    ...
    amenities: ["Smoking Room", "Mineral Water - additional charge", "Bathroom","In-room Dining","Housekeeping", "Laundry Service", "24-hour Room Service","Paid Wi-Fi","Heater - Additional charges","rating: 4.8","reviews: 156","popular: true"],
     rating: 4.9,
    reviews: 203,
  },
  {
